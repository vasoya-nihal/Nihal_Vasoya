...
<body>
    ...
    <div class="container-fluid pt-5 " style="background-color: #081B29 ;">
        <div class="row">
            <div class="col-lg-6  ani-text1">
                <div class="animate-text mt-5 d-flex justify-content-center" style="color: white;">
                    ...
                    <div class="home-content">
                        ...
                        <p>i'm web developer with extensive experince for 3 years.
                            <br>experties is to create and website design, frontend design
                        </p>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="ani-img d-flex justify-content-center">
                    <img src="assets/Blue Minimalist Instagram Profile Picture.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="row m-1">
            <div class="col-lg-7 center">
                <img src="assets/image_1_long.jpg.webp" class="img-fluid" alt="left side img">
            </div>
            <div class="col-lg-5">
                <div class="right-side-text">
                    <h1 class="text-center my-3">My Bio</h1>
                    <p>
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quam quos provident quibusdam? Quae
                        eius quibusdam doloremque iure dolorem accusantium, accusamus, ipsum laudantium consequuntur,
                        assumenda impedit id sint recusandae quas veritatis. Beatae officia recusandae incidunt ratione?
                    </p>
                    <p>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusamus debitis perferendis velit
                        quasi dolore vitae architecto fugiat expedita totam accusantium! Expedita, distinctio! Enim
                        aspernatur dolorem fugit laudantium porro ullam repudiandae!
                    </p>
            ...
            <div class="row items-3">
                <div class="col-lg-4 text-center">
                    <div class="service-items">
                        <span class="icon">
                            <!-- svg  -->
                            <span>
                                <svg width="5rem" height="5rem" viewBox="0 0 24 24" fill="none"
                ...
                <div class="col-lg-4 text-center">
                    <div class="service-items">
                        <span class="icon">
                            <!-- svg  -->
                            <svg height="5rem" width="5rem" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve"
                                fill="#96bb7c" stroke="#96bb7c">
    ...
    <div class="resume-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img src="assets/image_1_long.jpg.webp" alt="left-side-img" class="img-fluid">
                </div>
                <div class="col-lg-7">
                    <h3>
                        Work Experience
                    ...
                    <div class="resume-item">
                        <div>
                            ...
                            <span class="float-start">Rao Information Technology, Rajkot — Internship</span>
                        </div>
                        <div class="work-time float-end">
                            <!-- d-inline-block -->
                            <div class="months">
                            ...
                            <div class="float-end">
                                <span class="icon">
                                    <!-- svg -->
                                    <svg fill="#96bb7c" width="1rem" height="1rem" viewBox="0 0 1024 1024"
                                        xmlns="http://www.w3.org/2000/svg">
